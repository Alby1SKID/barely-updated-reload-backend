...
module.exports = {
    commandInfo: {
        name: "addall",
        description: "Adds the selected bundle to the locker",
        options: [
            {
                name: "user",
    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            const allItems = destr(fs.readFileSync(path.join(__dirname, "../../../Config/DefaultProfiles/bundleathena.json"), 'utf8'));
            if (!allItems) {
            ...
            const embed = new MessageEmbed()
                .setTitle("Bundle Added")
                .setDescription("Successfully added the bundle to the selected account")
                .setColor("GREEN")
                .setFooter({
                    text: "Reload Backend",
