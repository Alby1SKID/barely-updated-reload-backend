...
module.exports = {
    commandInfo: {
        name: "addbundle",
        description: "Allows you to give a  cosmetics. Note: This will reset all your lockers to default",
        options: [
            {
                name: "user",
    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            const allItems = destr(fs.readFileSync(path.join(__dirname, "../../../Config/DefaultProfiles/donateathena.json"), 'utf8'));
            if (!allItems) {
                return interaction.editReply({ content: "Failed to parse donateathena.json" });
            }
            ...
            const embed = new MessageEmbed()
                ...
                .setDescription("Successfully added the donator bundle to the selected account!")
                .setColor("GREEN")
                .setFooter({
                    text: "Reload Backend",
